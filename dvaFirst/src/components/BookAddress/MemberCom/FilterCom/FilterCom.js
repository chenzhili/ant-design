...
function Roles(props) {
    let { rolesArr, selectRolesOrMem, type, singleOrMultiple, selectedData, isTree, memArr, selectRolesGetMem, selectRolesActive,isCheck } = props;
...
function Member(props) {
    let { treeData, memArr, selectRolesOrMem, type, singleOrMultiple, isTree, selectedData, onSelect, selectedKeys,isCheck,selectRolesActive } = props;
    let memTreeProps = {
        draggable: false,
        treeData,
        onSelect,
