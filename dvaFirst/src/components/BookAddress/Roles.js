...
//         title: '您是否要移除所选成员？',
//         content: '移除成员会同时移除所选成员的当前角色身份，但不会在通讯录中删除所选成员',
//         onOk() {
                            ...
                            <Button className={styles.btn + " " + styles.addMem} onClick={() => {
                                controlFilter({
                                    ...
                                    showFilterArr: [
                                        ...
                                        { type: 1, name: "角色", idList: ["9088ac03-dfea-1e52-9700-803aecfc0564","bc93811e-33e5-78f3-17e8-354470c35807"], isTree: true }, */
