...
import {
    searchDepData, getMemData, getMemDetail, removeMemList, setDep, getFixedDep,
...
class Member extends Component {
    ...
    _getMemDataTable(id) {
        ...
        me.setState({
            ...
            getMemData({ OrganziationId: id || selectedKeys["0"], pageSize: memPageSize, pageIndex: memPageIndex }).then(res => {
                // console.log(res);
                me.setState({
                    tableLoad: false
                }, () => {
