...
import { Table, Switch, Input, Button, Popconfirm, Form, Select,Menu,Badge,Dropdown,Icon } from "antd";
...
const menu = (
  ...
  function NestedTable() {
    ...
    //   { title: 'Upgraded', dataIndex: 'upgradeNum', key: 'upgradeNum' },
      { title: 'Creator', dataIndex: 'creator', key: 'creator',width:"100px",className:styles.aaa },
      { title: 'Date', dataIndex: 'createdAt', key: 'createdAt',width:"100px" },
